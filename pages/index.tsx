...
function Row({text1,text2,text3} : {text1:String, text2:String, text3:String}) {
  return(
    <div className='w-full basis-1/4 flex-1 object-cover mx-auto shadow-xl rounded-2xl flex flex-col items-center justify-center divide-y p-10 divide-slate-200'>
    <h1 className='font-semibold w-full text-center rounded-md bg-slate-100 leading-8 py-3'>{text1}</h1>
      ...
      <main className=' bg-slate-50 md:px-96 lg:px-96'>
        ...
        <div className='flex flex-col gap-10 lg:flex-col lg:flex-wrap'>
          ...
          <Row text1 = "2014 - 2016 Infantry School for Reserved Officers"
            text2 = "Graduated the Infantry School of Reserve Officers and completed my military duties serving as a Reserve Second Lieutenan"
            text3=""
            />
